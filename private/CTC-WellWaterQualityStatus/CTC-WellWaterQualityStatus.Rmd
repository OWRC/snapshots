...
Status of each well in reference to the applicable half-Maximum Allowable Concentration and ODWQS objectives based on the most recent year of data. Please refer to [the description above](#Generalized_Additive_Mixed_Model) for more information on the exceedance likelihoods and confidence.
...
1. likelihood of exceedance is based on [comparison of GAMM and linear regression](#Generalized_Additive_Mixed_Model). 
